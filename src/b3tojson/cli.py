...
def process_args():
    ...
    parser.add_argument('--json_file', dest='json_file', action='store', help='Target JSON file path', default='stocks_data.json')
...
def main():
    ...
    obj = processor.FileHandle(b3_file, 'stocks_data.json')
    obj.analyze_file()
    obj.save_json()